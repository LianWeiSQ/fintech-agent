...
class EventExtractionAgent:
    def __init__(self, llm_client: LiteLLMClient, report_language: str) -> None:
    ...
    def run(self, clusters: list[NewsCluster]) -> list[CanonicalNewsEvent]:
        ...
        for cluster in clusters:
            ...
            if self.report_language.startswith("zh") and not primary.language.startswith("zh"):
                summary_seed = self.llm_client.translate(summary_seed)
